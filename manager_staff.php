...
<button type="button" class="btn btn-outline-warning" style="margin-top: 40px;margin-left:200px;"><a href="staff.php?action=staff&query=sua1" style="color: black;text-decoration: none;font-size: 26px;">+</a></button>
